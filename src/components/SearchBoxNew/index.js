...
class Search extends PureComponent {
  constructor(props) {
    ...
    this.autoCompleteView = new Animated.Value(0);
  ...
  onSearch = async () => {
    ...
    Animated.timing(this.autoCompleteView, {
      toValue: 0,
      duration: 400,
    }).start();
      ...
      <View>
        ...
        <Animated.View
          style={{
            ...
            right: 0,
            // minHeight: height - 30,
            height: this.autoCompleteView,
          }}>
            <View style={{ paddingHorizontal: 10, paddingVertical: 5 }}>
              {this.props.autoCompleteTexts.map(t =>
                <Ripple
                  key={t}
                  onPress={() => {
                    // this.props.keyboardShouldPersist === false ? Keyboard.dismiss() : null;
                  ...
                  style={{ width: '100%', paddingVertical: 10, margin: 0 }}
                >
                  <Text>{t}</Text>
                </Ripple>
              )}
...
Search.propTypes = {
   ...
   * auto complete
   */
  autoCompleteTexts: PropTypes.array,
